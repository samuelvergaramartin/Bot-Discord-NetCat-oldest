...
var ncomando = listallcommands.systemmaintenance;
var estadomodulo = estadomodulosdb.configuracion;
var estadocomando = estadocomandosdb.systemmodemaintenance;
...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        function ejecutarcomandoisOK() {
            systemstatus.set("mode", "under-maintenance");
            message.channel.send("System Status Mode changed to: under-maintenance");
}
        if(ncomando == privados.systemmaintenance) {
