...
var ncomando = listallcommands.systemonline;
var estadomodulo = estadomodulosdb.configuracion;
var estadocomando = estadocomandosdb.systemmodeonline;
...
module.exports = {
    ...
    run: async(netcat, message, args) => {
        ...
        function ejecutarcomandoisOK() {
            systemstatus.set("mode", "online");
            message.channel.send("System Status Mode changed to: online");
}
        if(ncomando == privados.systemonline) {
