...
var ncomando = listallcommands.clear;
var estadomodulo = estadomodulosdb.utiles;
var estadocomando = estadocomandosdb.clear;
    ...
    run: async(netcat, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
            async function ejecutarcomando() {
                if(!message.member.permissions.has("ManageMessages")) return message.channel.send("No tienes el permiso `ManageMessages`")
                if (!message.guild.members.me.permissions.has("ManageMessages")) {
                    return message.channel.send("**❌ | ERROR: **No tengo los permisos necesarios.\n Permisos que me faltan: `ManageMessages`.")
                    }
