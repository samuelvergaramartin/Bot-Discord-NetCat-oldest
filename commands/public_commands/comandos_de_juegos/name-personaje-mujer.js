...
var ncomando = listallcommands.namepersonajemujer;
var estadomodulo = estadomodulosdb.juegos;
var estadocomando = estadocomandosdb.namepersonajemujer;
var modulodeestecomando = juegos;
...
module.exports = {
    ...
    run: async(netcat, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
            ...
            .addFields([
                {  name: 'El nombre elegido es:', value: `${dado}` },
            ])
            .setColor('0xff00d9')
            .setTimestamp()
