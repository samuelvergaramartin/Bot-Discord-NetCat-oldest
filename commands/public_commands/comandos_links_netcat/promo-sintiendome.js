...
var ncomando = listallcommands.promosintiendome;
var estadomodulo = estadomodulosdb.links;
var estadocomando = estadocomandosdb.promosintiendome;
var modulodeestecomando = links;
    ...
    run: async(netcat, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
            async function ejecutarcomando() {
                message.channel.send("Sintiendo.me es la comunidad más grande de salud mental de Discord! Allí podrás hacer muchos amig@s y son todos muy amables y muy cariñosos, aparte de que están las 24 horas a tu servicio, si te sientes solo o necesitas ayuda, acude a Sintiendo.me! miau miau 😸.\nLink del servidor oficial de Sintiendo.me: https://discord.gg/VVGt3P7Q3d")
            }
