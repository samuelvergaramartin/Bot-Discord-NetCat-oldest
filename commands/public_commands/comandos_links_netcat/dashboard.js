...
var ncomando = listallcommands.dashboard;
var estadomodulo = estadomodulosdb.links;
var estadocomando = estadocomandosdb.dashboard;
...
module.exports = {
    ...
    run: async(netcat, message, args) => {
        ...
        .setTitle('Link de la DashBoard de NetCat')
        .setDescription('Aquí tienes mi DashBoard 😺~ [haz click aquí acceder a mi DashBoard](https://netcat.botdash.pro/)')
        .setColor('0xff00d9')
        .setTimestamp()
...
//console.log(`Comando: ${ncomando}: OFF`.grey)