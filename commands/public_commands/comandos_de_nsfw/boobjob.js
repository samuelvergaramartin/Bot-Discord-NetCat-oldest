...
var ncomando = listallcommands.boobjob;
var estadomodulo = estadomodulosdb.nsfw;
var estadocomando = estadocomandosdb.boobjob;
var modulodeestecomando = nsfw;
...
module.exports = {
    ...
    run: async(netcat, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
           ...
           if(!user) return message.channel.send(":x: || Debes mencionar alguien") || netcat.users.cache.get(args[0]) || message.author;
           //message.delete(10000);
           const boobjob = new EmbedBuilder()
