...
var ncomando = listallcommands.setprefix;
var estadomodulo = estadomodulosdb.configuracion;
var estadocomando = estadocomandosdb.setprefix;
    ...
    run: async(client, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
            async function ejecutarcomando() {
                ...
                prefixdb.establecer(message.guild.id, args[0]).catch(err => { return message.channel.send(err)})
