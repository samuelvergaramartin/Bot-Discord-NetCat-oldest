...
var ncomando = listallcommands.setgoodbyemessagedefault;
var estadomodulo = estadomodulosdb.configuracion;
var estadocomando = estadocomandosdb.setgoodbyemessagedefault;
        ...
        if(!perms) return message.channel.send("**:x: | ERROR:** No tienes los suficientes permisos.\nPermisos que te faltan: `Administrator`");
            ...
            if(goodbyemessage) {
                if(goodbyemessage === "DEFAULT") {
                    message.channel.send("**:x: | ERROR:** El mensaje de despedida por defecto ya está establecido en este servidor como mensaje de despedida.");
                }
                if(goodbyemessage !== "DEFAULT") {
                    
                goodbyemessagedb.set(`${message.guild.id}`, "DEFAULT")
                message.channel.send("Se ha establecido el mensaje de despedida por defecto como mensaje de despedida.");
                }
