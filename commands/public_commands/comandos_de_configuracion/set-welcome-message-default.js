...
var ncomando = listallcommands.setwelcomemessagedefault;
var estadomodulo = estadomodulosdb.configuracion;
var estadocomando = estadocomandosdb.setwelcomemessagedefault;
        ...
        if(!perms) return message.channel.send("**:x: | ERROR:** No tienes los suficientes permisos.\nPermisos que te faltan: `Administrator`");
            ...
            if(welcomemessage) {
                if(welcomemessage === "DEFAULT") {
                    message.channel.send("**:x: | ERROR:** El mensaje de bienvenida por defecto ya está establecido en este servidor como mensaje de bienvenida.");
                }
                if(welcomemessage !== "DEFAULT") {
                    
                welcomemmessagedb.set(`${message.guild.id}`, "DEFAULT")
                message.channel.send("Se ha establecido el mensaje de bienvenida por defecto como mensaje de bienvenida.");
                }
