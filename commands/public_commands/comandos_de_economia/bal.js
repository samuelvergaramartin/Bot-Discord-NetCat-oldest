...
var ncomando = listallcommands.bal;
var estadomodulo = estadomodulosdb.economia;
var estadocomando = estadocomandosdb.bal;
            ...
            async function ejecutarcomando() {
                ...
                if(!persona){
                  ...
                  const embed1 = new EmbedBuilder()
                    ...
                    .addFields([
                        {  name: `En tu cartera:`, value: `${cantidad}:coin:` },
                        {  name: `En el banco:`, value: `${cantidad2}:coin:` },
                        {  name: `En total:`, value: `${cantidad + cantidad2}:coin:` },
                    ])
                    .setColor('0xff00d9')
                    .setFooter({text:`Sistema de economía NetCat`});
                ...
                if(persona){
                  ...
                  const embed1 = new EmbedBuilder()
                    ...
                    .setAuthor({name:`${persona.tag}`,iconURL: message.author.displayAvatarURL({format: "png"})})
                    .setDescription(`:money_with_wings:**Global**`)
                    .addFields([
                        {  name: `En tu cartera:`, value: `${cantidad}:coin:` },
                        {  name: `En el banco:`, value: `${cantidad2}:coin:` },
