...
var ncomando = listallcommands.chiste0positivo;
var estadomodulo = estadomodulosdb.chistes;
var estadocomando = estadocomandosdb.chiste0positivo;
var modulodeestecomando = chistes;
    ...
    run: async(client, message, args) => {
        ...
        async function ejecutarcomandoisOK() {
            async function ejecutarcomando() {
                message.channel.send(`-¡Rápido, necesitamos sangre!
                -Yo soy 0 positivo.
