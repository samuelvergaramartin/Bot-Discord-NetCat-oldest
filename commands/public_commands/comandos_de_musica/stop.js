...
var ncomando = listallcommands.stop;
var estadomodulo = estadomodulosdb.musica;
var estadocomando = estadocomandosdb.stop;
...
module.exports = {
    ...
    if (!pvc) {
        message.reply("No se esta reproduciendo musica");
    } 
         ...
         message.channel.send("Cola de la pista borrada y he abandonado el canal de voz.");
    }
